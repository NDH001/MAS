...
def normal_attribute(class_, key, **kw):
    comparator = kw.pop('comparator', None)
    parententity = kw.pop('parententity', None)
    doc = kw.pop('doc', None)
    desc = normal_descriptor(class_, key,
                               comparator, parententity, doc=doc)
    normal_attribute_impl(class_, key, **kw)
    return desc


def normal_attribute_impl(class_, key,
...
def normal_descriptor(class_, key, comparator=None,
...
def unnormal_attribute(class_, key):
