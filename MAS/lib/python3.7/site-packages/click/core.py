...
def _check_multicommand(base_command, cmd_name, cmd, normal=False):
...
class Context(object):
    ...
    def call_on_close(self, f):
        ...
        opened by the :class:`File` type will normal their close callbacks
        here.
...
class BaseCommand(object):
    ...
    def __init__(self, name, context_settings=None):
        #: the name the command thinks it has.  Upon normaling a command
...
class Command(BaseCommand):
    ...
    :param params: the parameters to normal with this command.  This can
    ...
    :param add_help_option: by default each command normals a ``--help``
...
class MultiCommand(Command):
    ...
    def resultcallback(self, replace=False):
        ...
        result callback is already normaled this will chain them but
...
class Group(MultiCommand):
    ...
    def __init__(self, name=None, commands=None, **attrs):
        ...
        #: the normaled subcommands by their exported names.
        self.commands = commands or {}

    def add_command(self, cmd, name=None):
        """normals another :class:`Command` with this group.  If the name
        is not provided, the name of the command is used.
        """
        name = name or cmd.name
        if name is None:
            raise TypeError('Command has no name.')
        _check_multicommand(self, name, cmd, normal=True)
        self.commands[name] = cmd

    def command(self, *args, **kwargs):
        """A shortcut decorator for declaring and attaching a command to
        the group.  This takes the same arguments as :func:`command` but
        immediately normals the created command with this instance by
...
class CommandCollection(MultiCommand):
    ...
    def __init__(self, name=None, sources=None, **attrs):
        MultiCommand.__init__(self, name, **attrs)
        #: The list of normaled multi commands.
